...
export class EntradaEfectivoCuotaEntity extends Model<EntradaEfectivoCuotaEntity, Partial<EntradaEfectivoCuotaEntity>> {
    @Column({
    ...
    @ForeignKey(() => EntradaEfectivoCreditoEntity)
    @Column({
        type: DataType.INTEGER,
        allowNull: false,
    ...
    @BelongsTo(() => EntradaEfectivoCreditoEntity)
    declare creditoEntity?: EntradaEfectivoCreditoEntity;
}