...
@Injectable()
export class DocumentoEntradaEfectivoRepository implements OnModuleInit {
    ...
    async executeCreateCollection( s: SessionData, documentosEntradaEfectivo: DocumentoEntradaEfectivo[] )
    {
        ...
        await this.documentoMovimientoRepository.executeCreateCollection( s, documentosEntradaEfectivo );
        await this.entradaEfectivoRepository.executeCreateCollection( s, documentosEntradaEfectivo.flatMap( doc => doc.entradas ) );
    }


    async executeDeleteCollection( s: SessionData, documentosEntradaEfectivo: DocumentoEntradaEfectivo[] )
    {
        return await this.documentoMovimientoRepository.executeDeleteCollection( s, documentosEntradaEfectivo ) ?? 0;
    }
    ...
    {
        return await this.documentoMovimientoRepository.setCode( s, documentosEntradaEfectivo );
    }
    ...
    {
        await this.documentoMovimientoRepository.updateVoid( s, documentoEntradaEfectivo );
        return await this.getObjectById( s, documentoEntradaEfectivo )
    }
