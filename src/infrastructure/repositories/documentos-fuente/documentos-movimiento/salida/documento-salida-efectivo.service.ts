...
@Injectable()
export class DocumentoSalidaEfectivoRepository {
    ...
    {
        await this.documentoMovimientoRepository.executeCreateCollection( s, documentosSalidaEfectivo );
        await this.salidaEfectivoRepository.executeCreateCollection( s, documentosSalidaEfectivo.flatMap( doc => doc.salidas ) );
    }


    async executeDeleteCollection( s: SessionData, documentosSalidaEfectivo: DocumentoSalidaEfectivo[] )
    {
        return await this.documentoMovimientoRepository.executeDeleteCollection( s, documentosSalidaEfectivo );
    }
    ...
    {
        return await this.documentoMovimientoRepository.setCode( s, documentosSalidaEfectivo );
    }
    ...
    {
        await this.documentoMovimientoRepository.updateVoid( s, documentoSalidaEfectivo );
        return await this.getObjectById( s, documentoSalidaEfectivo );
    }
