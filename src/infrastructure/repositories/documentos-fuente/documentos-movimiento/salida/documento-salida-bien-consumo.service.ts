...
@Injectable()
export class DocumentoSalidaBienConsumoRepository {
    ...
    {
        await this.documentoMovimientoRepository.executeCreateCollection( s, documentosSalidaBienConsumo );
        await this.salidaBienConsumoRepository.executeCreateCollection( s, documentosSalidaBienConsumo.flatMap( doc => doc.salidas ) );
    }


    async executeDeleteCollection( s: SessionData, documentosSalidaBienConsumo: DocumentoSalidaBienConsumo[] )
    {
        return await this.documentoMovimientoRepository.executeDeleteCollection( s, documentosSalidaBienConsumo );
    }
    ...
    {
        return await this.documentoMovimientoRepository.setCode( s, documentosSalidaBienConsumo );
    }
    ...
    {
        await this.documentoMovimientoRepository.updateVoid( s, documentoSalidaBienConsumo );
        return await this.getObjectById( s, documentoSalidaBienConsumo );
    }
